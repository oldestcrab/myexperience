...
def index_page(page, judge_page):
    ...
    for i in range(page_start,page):
        ...
        try:
            ...
            with open('./judge_page_danbai.txt', 'w', encoding = 'utf-8') as f:
...
def save_page(kw):
    ...
    """
    if kw:
        with open('./kw_danbai.txt', 'a', encoding = 'utf-8') as f:
            f.write(str(kw) + '\n')
...
def main():
    ...
    with open('./judge_page_danbai.txt', 'r', encoding = 'utf-8') as f:
            judge_page = f.read()
    # judge = 2
