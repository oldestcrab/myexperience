    ...
    if source_article:
        ...
        def url_img_name(match):
            ...
            if img_real_name:
                ...
                img_name = ' src="/home/bmnars/data/ebiotrade_spider_result/img/' + kw_img_name + '"'
                # else:
...
def save_img(source, filename):
    ...
    """
    dir_save_img= '/home/bmnars/data/ebiotrade_spider_result/img/'
...
def save_page(page_title,source,filename):
    ...
    """
    dir_save_page = '/home/bmnars/data/ebiotrade_spider_result/'
...
def save_mysql(url_source, url_local):
    ...
    cursor = db.cursor()
    url_local_full = '/home/bmnars/data/ebiotrade_spider_result/' + url_local 
    update_time = time.strftime('%Y-%m-%d',time.localtime())
    data = {
        'source_url':url_source,
        'local_url':url_local_full,
        'source':'www.ebiotrade.com',
