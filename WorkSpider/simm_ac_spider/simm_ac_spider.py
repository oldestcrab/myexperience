...
def get_index_page(index_page, last_judge, last_judge_name, index_url):
    ...
    for index_page in range(1,index_page):    
        ...
        if index_response:
            ...
            index_source_list = index_html.xpath('//td[@height="22"]/a/@href')
            ...
            for index_source in index_source_list:
                ...
                # 获取文章部分url
                page_url = 'http://www.simm.ac.cn/xwzx/kydt' + index_source.replace('./', '/')
...
# 图片替换路径
IMG_CHANGE_DIR = './img/'
# IMG_CHANGE_DIR = '/home/bmnars/data/simm_ac_spider_result/img/'

# 文件存储路径
PAGE_SAVE_DIR = sys.path[0] + '/simm_ac_spider_result/'
# PAGE_SAVE_DIR = '/home/bmnars/data/simm_ac_spider_result/'

# 文章来源网站
ARTICLE_ORIGIN_WEBSITE = 'http://www.simm.ac.cn'
...
def main():
    ...
    for wd in range(1):
        ...
        if wd == 0:
            ...
            # 索引url
            index_url = 'http://www.simm.ac.cn/xwzx/kydt/index'
            # 要爬取的索引总页数
            index_page = 2
