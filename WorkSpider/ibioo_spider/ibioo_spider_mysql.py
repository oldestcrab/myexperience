    ...
    if source_article:
        ...
        def url_img_name(match):
            ...
            if img_real_name:
                ...
                img_name = ' src="/home/bmnars/data/ibioo_spider_result/img/' + kw_img_name + '"'
                # else:
        ...
        # 保存文章内容 
        save_mysql(url_article, filename.group(1))
...
def save_img(source, filename):
    ...
    """
    dir_save_img= '/home/bmnars/data/ibioo_spider_result/img/'
...
def save_page(source,filename):
    ...
    """
    dir_save_page ='/home/bmnars/data/ibioo_spider_result/'
...
def save_mysql(url_source, url_local):
    ...
    cursor = db.cursor()
    url_local_full = '/home/bmnars/data/ibioo_spider_result/' + url_local  
