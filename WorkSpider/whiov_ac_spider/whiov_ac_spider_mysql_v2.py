...
def parse_page(source_local):
    ...
    title_article = html_source_local.xpath('////div[@class="xl_h"]')[0].text.strip()
    ...
    if source_article:
        ...
        def img_url_name(match):
            ...
            if img_real_name and match.group(1):
                ...
                img_name = '<img src="/home/bmnars/data/whiov_ac_spider_result_v2/img/' + kw_img_name + '" />'
        ...
        # 剔除一些杂乱的样式
        source_local = source_local.replace('&nbsp;','').replace('<i style="line-height: 175%; font-size: 12pt">','').strip()
...
def save_img(source, filename):
    ...
    """
    dir_save_img = '/home/bmnars/data/whiov_ac_spider_result_v2/img/'
...
def save_page(list_article,filename):
    ...
    """
    dir_save_page = '/home/bmnars/data/whiov_ac_spider_result_v2/'
...
def save_mysql(url_source, url_local):
    ...
    cursor = db.cursor()
    url_local_full = '/home/bmnars/data/whiov_ac_spider_result_v2/' + url_local  
