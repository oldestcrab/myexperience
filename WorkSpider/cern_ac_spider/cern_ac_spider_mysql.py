...
def get_page(url):
    ...
    if source_article:
        ...
        def url_img_name(match):
            ...
            if img_real_name:
                img_name  = ' src="/home/bmnars/data/cern_ac_spider_result/img/' + name_save_img + '"'
                return img_name
...
def save_img(source, filename):
    ...
    """
    name_save_img =  '/home/bmnars/data/cern_ac_spider_result/img/' + filename 
    try:
        # 保存图片
...
def save_page(source,filename):
    ...
    """
    try:
        with open('/home/bmnars/data/cern_ac_spider_result/' + filename + '.html', 'w', encoding = 'utf-8') as f:
            f.write(source)
    except  OSError as e:
...
def save_mysql(url_source, url_local):
    ...
    cursor = db.cursor()
    url_local_full = '/home/bmnars/data/cern_ac_spider_result/' + url_local  + '.html'
