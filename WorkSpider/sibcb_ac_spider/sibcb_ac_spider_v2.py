    ...
    if article_response:
        ...
        if article_source:
            ...
            if IMG_EXISTS:
                ...
                article_source = article_source.replace('<DIV>', '<p>').replace('</DIV>', '</p>').replace('<div>', '<p>').replace('</div>', '</p>')
                article_sub_content = parse_page.sub_article_content(article_source, IMG_CHANGE_DIR)
                article_sub_content = article_sub_content.replace('<I>', '').replace('<i>', '').replace('</I>', '').replace('</i>', '')
